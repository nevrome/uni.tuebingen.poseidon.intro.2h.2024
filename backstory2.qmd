...
Just while you still ogle at the first PCA result you receive another email from Prof. P. with a second photograph^[Prompt : "A film still of the frozen hand of an ice mummy in a mass spectrometer. In the background the yeti works on the massive machine". Made with Microsoft Bing Image Creator.] from the field lab. 
