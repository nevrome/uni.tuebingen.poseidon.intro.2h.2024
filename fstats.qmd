...
It also allow to list multiple different statistics in the `fstats` blog, which will then all be calculated in one `xerxes` run.
:::
...
::: {.callout-tip}
## Learn more
Stephan Schiffels, the main author of `xerxes`, recently introduced F-statistics and his tool [here](https://mpi-eva-archaeogenetics.github.io/comp_human_adna_book/fstats.html).
:::
